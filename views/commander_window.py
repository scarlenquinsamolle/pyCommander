...
class CommanderWindow(QtGui.QMainWindow):
    ...
    def setup_menu_bar(self):
        ...
        #New File option
        self.action_new_file = QtGui.QAction(self)
        self.action_new_file.setText("New File")
        self.action_new_file.setShortcut("Ctrl+N")
        self.action_new_file.triggered.connect(self.file_manager.add_new_file)
    ...
    def setup_connections(self):
        ...
        self.tab_right.tree_view.clicked.connect(self.switch_to_right_panel)
        self.connect(self.tab_right.tree_view, QtCore.SIGNAL("tabPressed"), self.switch_to_left_panel)
        self.tab_left.tree_view.clicked.connect(self.switch_to_left_panel)
